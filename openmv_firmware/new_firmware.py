...
class ROS2_Interface:
    ...
    def stream_generator_cb(self):
        ...
        #prepare bytearray() to send as stream
    ...
    def movement_im_stream(self, data):
        ...
        self.interface.schedule_callback(self.jpeg_image_stream_cb)
        return "Ready".encode()
